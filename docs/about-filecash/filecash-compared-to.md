---
title: Filecash compared to...
description: While Filecash shares some similarities to other file storage solutions, the protocol has significant differences that one should consider.
---

# Comparing Filecash

Filecash combines many elements of other file storage and distribution systems. What makes Filecash unique is that it runs on an open, peer-to-peer network while still providing economic incentives and proofs to ensure files are being stored correctly. This page compares Filecash against other technologies that share some of the same properties.

- [Filecash vs. Amazon S3, Google Cloud Storage](#filecoin-vs-amazon-s3-google-cloud-storage)
- [Filecash vs. Bitcoin](#filecoin-vs-bitcoin)

### Filecash vs. Amazon S3, Google Cloud Storage
...
<table class="comparison">
    ...
    <tr>
        <td>API</td>
        <td>Applications can access all storage providers using the Filecash protocol</td>
    ...
    <tr>
        <td>Support</td>
        <td>If something goes wrong, the Filecash protocol determines what happens without human intervention</td>
